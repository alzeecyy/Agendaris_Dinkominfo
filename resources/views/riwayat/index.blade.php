        ...
        <div class="overflow-x-auto rounded-2xl border border-[#d4d1f5]/60">
            <table class="w-full text-left text-xs text-[#2e2552]">
                <thead class="bg-[#ebf2ff] text-[#1b3bbb] border-b border-[#d4d1f5]/80 select-none">
                    <tr>
                        <th class="py-3.5 px-4 sm:px-5 text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-[#1b3bbb]">Nama Agenda Kegiatan</th>
                        <th class="py-3.5 px-4 sm:px-5 text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-[#1b3bbb] text-center">Kategori</th>
                        <th class="py-3.5 px-4 sm:px-5 text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-[#1b3bbb] whitespace-nowrap">Tanggal & Jam</th>
                        <th class="py-3.5 px-4 sm:px-5 text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-[#1b3bbb]">Lokasi</th>
                        <th class="py-3.5 px-4 sm:px-5 text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-[#1b3bbb] text-center leading-tight whitespace-nowrap">Status Kehadiran</th>
                        <th class="py-3.5 px-4 sm:px-5 text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-[#1b3bbb] text-center whitespace-nowrap">Notulensi</th>
                    </tr>
                </thead>
                    ...
                    @forelse($riwayatData as $item)
                        <tr class="agenda-row hover:bg-[#f8f7ff] cursor-pointer transition-colors"
                            ...
                            <td class="py-3.5 px-4 sm:px-5 text-center whitespace-nowrap">
                                @php
                                    $badgeStyles = [
                                        'rapat' => 'bg-rose-50 text-rose-600 border-rose-100',
                                        'sosialisasi' => 'bg-blue-50 text-blue-600 border-blue-100',
                                        'pelatihan' => 'bg-emerald-50 text-emerald-600 border-emerald-100',
                                        'kegiatan_lainnya' => 'bg-slate-100 text-slate-600 border-slate-200',
                                    ];
                                    $kategoriLabels = [
                                        'rapat' => 'RAPAT',
                                ...
                                @endphp
                                <span class="inline-block text-[9.5px] sm:text-[10px] px-2.5 py-0.5 font-extrabold uppercase rounded-md border 
                            ...
                            <td class="py-3.5 px-4 sm:px-5 text-xs font-semibold">
                                <div class="text-[#2e2552] font-semibold">{{ $item->tanggal->translatedFormat('d M Y') }}</div>
                            ...
                            <td class="py-3.5 px-4 sm:px-5 text-center text-xs">
                                ...
                                @else
                                    <span class="inline-block px-2.5 py-0.5 rounded-lg bg-slate-100/80 text-slate-400 border border-slate-200/60 font-bold">-</span>
                                @endif
                            </td>
                            <td class="py-3.5 px-4 sm:px-5 text-center text-xs whitespace-nowrap">
                                ...
                                @else
                                    <span class="inline-block px-2.5 py-0.5 text-slate-400 text-[11px] font-medium italic">Belum Disahkan</span>
                                @endif
                            </td>
                        </tr>
                    @empty
