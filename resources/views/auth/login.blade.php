...
<body class="min-h-screen bg-[#eef2ff] text-[#2e2552] flex flex-col items-center justify-center p-3.5 sm:p-6 md:p-8 relative overflow-x-hidden antialiased select-none">
    ...
    <div class="w-full max-w-5xl my-auto relative z-10 flex flex-col items-center">
        ...
        <div x-data="{ showPassword: false }" class="w-full glass-card border border-white/90 rounded-2xl sm:rounded-3xl md:rounded-[36px] shadow-2xl shadow-[#09103c]/10 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-0 lg:min-h-[580px] relative">
            
            <!-- ================= LEFT PANEL: GRADIENT NAVY BRANDING HERO (Desktop Only) ================= -->
            <div class="hidden lg:flex lg:col-span-6 bg-gradient-to-br from-[#09103c] via-[#142370] to-[#1b3bbb] text-white p-8 md:p-10 flex-col justify-between relative overflow-hidden">
                
                <!-- White Organic Wave Divider (Slim elegant curve at panel edge) -->
                <div class="absolute top-0 bottom-0 -right-2 w-16 z-20 pointer-events-none text-white">
            ...
            <div class="col-span-1 lg:col-span-6 bg-gradient-to-br from-white via-[#f8f9ff] to-[#eef2ff] p-5 sm:p-10 md:p-12 lg:pl-10 flex flex-col justify-center relative z-10 overflow-hidden">
                ...
                <div class="space-y-4 sm:space-y-6 my-auto relative z-10 max-w-md mx-auto w-full">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-4 sm:space-y-5">
                        ...
                        <!-- Error Alert -->
                        @if($errors->any())
                            <div class="bg-rose-50 border border-rose-200 text-rose-700 rounded-2xl p-3.5 sm:p-4 text-xs space-y-1.5 shadow-2xs">
                        ...
                        <!-- Warning Alert -->
                        @if(session('warning'))
                            <div class="bg-amber-50 border border-amber-200 text-amber-800 rounded-2xl p-3.5 sm:p-4 text-xs flex items-start gap-2.5 shadow-2xs">
                        ...
                        <div class="space-y-1.5 sm:space-y-2">
                            ...
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-3.5 sm:pl-4 flex items-center pointer-events-none">
                                    <svg class="w-4.5 h-4.5 sm:w-5 sm:h-5 text-[#8e88dd] group-focus-within:text-[#1b3bbb] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-1.5 sm:space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <button type="button" @click="showPassword = !showPassword" tabindex="-1" class="absolute inset-y-0 right-0 pr-3.5 sm:pr-4 flex items-center text-slate-400 hover:text-[#1b3bbb] transition-colors cursor-pointer" title="Tampilkan/Sembunyikan Kata Sandi">
                                    <svg x-show="!showPassword" class="w-4.5 h-4.5 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                    </svg>
                                    <svg x-show="showPassword" x-cloak class="w-4.5 h-4.5 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
