...
@section('content')
<div class="w-full bg-white rounded-2xl md:rounded-[24px] p-3.5 sm:p-4 md:p-5 shadow-xs border border-slate-100/80 space-y-3">
    ...
    <div class="space-y-3">
        <div class="flex items-center justify-between border-b border-slate-100 pb-2">
            ...
            <a href="{{ route('password.change') }}" class="px-2.5 py-1.5 bg-indigo-50/80 hover:bg-indigo-100 text-indigo-700 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border border-indigo-100/80 shrink-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
            ...
            <div class="space-y-0.5">
                ...
                <div class="text-xs sm:text-sm font-bold text-[#09103c] bg-slate-50/80 border border-slate-200/70 rounded-xl px-3 py-1.5 font-mono shadow-xs">
                    {{ Auth::user()->nip }}
                </div>
            </div>
            ...
            <div class="space-y-0.5">
                ...
                <div class="text-xs sm:text-sm font-bold text-[#09103c] bg-slate-50/80 border border-slate-200/70 rounded-xl px-3 py-1.5 shadow-xs">
                    {{ Auth::user()->name }}
                </div>
            </div>
            ...
            <div class="space-y-0.5">
                ...
                <div class="text-xs sm:text-sm font-bold text-emerald-600 bg-slate-50/80 border border-slate-200/70 rounded-xl px-3 py-1.5 shadow-xs flex items-center gap-2">
